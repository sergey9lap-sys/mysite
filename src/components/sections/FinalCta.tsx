...
export function FinalCta() {
  return (
    <section id="contact" data-reveal-section className="relative z-10 overflow-hidden border-b border-sakura/15 bg-ink">
      <div aria-hidden className="absolute inset-0 bg-[url('/images/hero/sakura-digital-bg.png')] bg-cover bg-[60%_56%] opacity-48" />
      <div
        aria-hidden
      ...
      <div className="section-shell relative grid min-h-[760px] items-center gap-14 py-24 lg:grid-cols-[1.05fr_0.85fr]">
        <div>
        ...
        <div className="relative min-h-[560px]">
          <div aria-hidden className="absolute right-[4%] top-[7%] h-[86%] w-[78%] rotate-[3deg] rounded-[1.4rem] border border-sakura/35 bg-white/[0.025] shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_0_110px_rgba(255,112,166,0.25)] backdrop-blur-xl" />
          <div aria-hidden className="absolute bottom-[5%] right-[16%] h-20 w-[54%] bg-[radial-gradient(ellipse_at_50%_50%,rgba(255,112,166,0.82),transparent_70%)] blur-2xl" />

          <div className="absolute right-[7%] top-[10%] flex h-[82%] w-[78%] rotate-[3deg] flex-col overflow-hidden rounded-[1.35rem] border border-sakura/50 bg-black/30 p-8 shadow-[0_44px_180px_rgba(255,112,166,0.25)] backdrop-blur-2xl">
            ...
            <div className="mt-auto flex flex-col gap-4">
              <ButtonLink
                href={telegramUrl}
                icon="send"
                className="min-h-16 justify-between border-sakura/80 bg-sakura/90 px-7 text-base text-white shadow-[0_0_70px_rgba(255,112,166,0.46)] hover:bg-sakura"
              >
                Написать в Telegram
              </ButtonLink>
              <ButtonLink href="#projects" variant="ghost" className="min-h-16 justify-between px-7 text-base">
